...
class TestVectorStoreSearch:
    ...
    def test_post_search_invalid_similarity_threshold_400(self, client, text_search_request):
    ...
    def test_post_search_response_schema(self, client, text_search_request):
        ...
        required_fields = ["results", "query_embedding", "total_results", "search_time_ms"]
    ...
    def test_post_search_result_item_schema(self, client, text_search_request):
        ...
        if response_data["results"]:
            ...
            required_fields = [
                "chunk_id", "similarity_score", "text_content", 
    ...
    def test_post_search_results_sorted_by_similarity(self, client, text_search_request):
        ...
        search_request["similarity_threshold"] = 0.1  # Lower threshold to get more results
    ...
    def test_post_search_similarity_threshold_filtering(self, client, text_search_request):
