...
class TestVectorStorePostEmbeddings:
    ...
    def test_post_embeddings_success_201(self, client, valid_embedding_request):
        ...
        response = client.post("/vector-store/embeddings", json=valid_embedding_request)
    ...
    def test_post_embeddings_invalid_dimensions_400(
        self, client, invalid_embedding_request_short_vector
    ):
        """Test embedding with wrong dimensions returns 400."""
        response = client.post(
            "/vector-store/embeddings", json=invalid_embedding_request_short_vector
        )
        ...
        assert (
            "embedding must contain exactly 768 dimensions" in response_data["message"]
        )

    def test_post_embeddings_missing_fields_400(
        self, client, invalid_embedding_request_missing_fields
    ):
        """Test request with missing required fields returns 400."""
        response = client.post(
            "/vector-store/embeddings", json=invalid_embedding_request_missing_fields
        )
    ...
    def test_post_embeddings_duplicate_chunk_id_409(
        self, client, valid_embedding_request
    ):
        """Test duplicate chunk_id returns 409 Conflict."""
        # First insertion should succeed
        response1 = client.post(
            "/vector-store/embeddings", json=valid_embedding_request
        )
    ...
    def test_post_embeddings_invalid_artifact_type_400(
        self, client, valid_embedding_request
    ):
        ...
        response = client.post("/vector-store/embeddings", json=invalid_request)
    ...
    def test_post_embeddings_text_content_too_short_400(
        self, client, valid_embedding_request
    ):
    ...
    def test_post_embeddings_invalid_embedding_values_400(
        self, client, valid_embedding_request
    ):
    ...
    def test_post_embeddings_content_type_validation(
        self, client, valid_embedding_request
    ):
