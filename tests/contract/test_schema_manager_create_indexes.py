...
class TestSchemaManagerCreateIndexes:
    ...
    def test_post_create_indexes_success_201(self, client, valid_create_indexes_request):
        """Test successful index creation returns 201."""
        response = client.post(
            "/schema/indexes",
            json=valid_create_indexes_request
        )
            ...
            "indexes": [
                {
                    ...
                    "distance_type": "COSINE",
                    "options": {
                        "num_lists": 6000  # Too high - max is 5000
                    }
                }
            ]
        }
    ...
    def test_post_create_indexes_response_schema(self, client, valid_create_indexes_request):
    ...
    def test_get_indexes_response_schema(self, client):
        ...
        for index in response_data["indexes"]:
            required_fields = [
                "name", "table", "column", "status", "index_type", 
                "distance_type", "coverage_percentage"
            ]
            for field in required_fields:
            ...
            "indexes": [
                {
                    ...
                    "distance_type": "COSINE",
                    "options": {
                        "fraction_lists_to_search": 1.5  # Invalid: > 1.0
                    }
                }
            ]
        }
