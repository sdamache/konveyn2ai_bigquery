...
class TestSchemaManagerCreateTables:
    ...
    def test_post_create_tables_success_201(self, client, valid_create_tables_request):
        ...
        response = client.post(
            "/schema/tables",
            json=valid_create_tables_request
        )
    ...
    def test_post_create_tables_already_exist_409(self, client, valid_create_tables_request):
    ...
    def test_post_create_tables_force_recreate_success_201(self, client, valid_create_tables_request):
    ...
    def test_post_create_tables_response_schema(self, client, valid_create_tables_request):
        ...
        for table in response_data["tables_created"]:
            required_table_fields = ["name", "full_name", "schema", "partitioning", "clustering"]
    ...
    def test_post_create_tables_schema_field_validation(self, client, valid_create_tables_request):
        ...
        metadata_table = next(
            (t for t in response_data["tables_created"] if t["name"] == "source_metadata"), 
            None
        )
        if metadata_table:
    ...
    def test_post_create_tables_partitioning_config(self, client, valid_create_tables_request):
        ...
        for table in response_data["tables_created"]:
            ...
            assert partitioning["expiration_days"] == valid_create_tables_request["partition_expiration_days"]
