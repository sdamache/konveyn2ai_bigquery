...
class TestSchemaManagerValidate:
    ...
    def basic_validation_request(self):
        ...
        return {"validate_data": False, "check_indexes": True, "sample_size": 1000}

    @pytest.fixture
    def full_validation_request(self):
        """Full validation request including data validation."""
        return {"validate_data": True, "check_indexes": True, "sample_size": 5000}
    ...
    def test_post_validate_schema_success_200(self, client, basic_validation_request):
        ...
        response = client.post("/schema/validate", json=basic_validation_request)
    ...
    def test_post_validate_schema_with_data_validation_200(
        self, client, full_validation_request
    ):
        """Test schema validation with data validation enabled."""
        response = client.post("/schema/validate", json=full_validation_request)
    ...
    def test_post_validate_schema_invalid_sample_size_400(self, client):
        ...
        response = client.post("/schema/validate", json=invalid_request)
    ...
    def test_post_validate_schema_response_schema(
        self, client, basic_validation_request
    ):
    ...
    def test_post_validate_schema_table_validation_results(
        self, client, basic_validation_request
    ):
    ...
    def test_post_validate_schema_index_validation_results(
        self, client, basic_validation_request
    ):
    ...
    def test_post_validate_schema_with_data_quality_report(
        self, client, full_validation_request
    ):
    ...
    def test_post_validate_schema_embedding_quality_checks(
        self, client, full_validation_request
    ):
        ...
        if "data_quality" in response_data:
            embedding_quality = response_data["data_quality"].get(
                "embedding_quality", {}
            )
    ...
    def test_post_validate_schema_metadata_quality_checks(
        self, client, full_validation_request
    ):
    ...
    def test_post_validate_schema_referential_integrity_checks(
        self, client, full_validation_request
    ):
        ...
        if "data_quality" in response_data:
            ref_integrity = response_data["data_quality"].get(
                "referential_integrity", {}
            )
    ...
    def test_post_validate_schema_recommendations(
        self, client, basic_validation_request
    ):
    ...
    def test_post_validate_schema_invalid_overall_status(
        self, client, basic_validation_request
    ):
    ...
    def test_post_validate_schema_check_indexes_false(self, client):
        ...
        no_index_request = {"validate_data": False, "check_indexes": False}

        response = client.post("/schema/validate", json=no_index_request)
