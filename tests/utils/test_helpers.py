...
class JSONRPCTestClient:
    ...
    async def call(self, method: str, params: Dict[str, Any] = None, request_id: str = None) -> Dict[str, Any]:
...
class MockDataGenerator:
    ...
    @staticmethod
    def generate_code_snippet(file_path: str = None, language: str = "python") -> Dict[str, str]:
    ...
    @staticmethod
    def generate_multiple_snippets(count: int = 5, languages: List[str] = None) -> List[Dict[str, str]]:
...
class TestResponseValidator:
    ...
    @staticmethod
    def validate_jsonrpc_response(response: Dict[str, Any], expected_id: str = None) -> bool:
    ...
    def validate_search_response(response: Dict[str, Any]) -> bool:
        ...
        for snippet in result["snippets"]:
            ...
            if not isinstance(snippet["file_path"], str) or not isinstance(snippet["content"], str):
                return False
...
class ErrorTestHelper:
    ...
    @staticmethod
    def create_jsonrpc_error(code: int = -32603, message: str = "Internal error") -> Dict[str, Any]:
...
class MockServiceFactory:
    ...
    def create_mock_janapada(snippets: List[Dict[str, str]] = None):
        ...
        async def mock_search(method: str, params: Dict[str, Any], **kwargs):
            if method == "search":
                return {
                    "snippets": snippets or MockDataGenerator.generate_multiple_snippets(3)
                }
            else:
    ...
    def create_mock_amatya(advice: str = None):
        ...
        async def mock_advise(method: str, params: Dict[str, Any], **kwargs):
            if method == "advise":
                ...
                default_advice = f"As a {role}, here's my advice based on the provided code..."
                return {
...
class AssertionHelpers:
    ...
    def assert_response_time(actual_time: float, max_time: float):
        ...
        if actual_time > max_time:
            raise AssertionError(f"Response time {actual_time:.3f}s exceeds maximum {max_time:.3f}s")
    ...
    def assert_no_duplicates(items: List[Any]):
        ...
        if len(unique_items) != len(items):
            raise AssertionError(f"List contains duplicates: {len(items)} items, {len(unique_items)} unique")
    ...
    def assert_json_structure(data: Dict[str, Any], expected_structure: Dict[str, type]):
        ...
        for key, expected_type in expected_structure.items():
            ...
            if not isinstance(data[key], expected_type):
                raise AssertionError(f"Key '{key}' has type {type(data[key])}, expected {expected_type}")
