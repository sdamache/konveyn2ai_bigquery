...
def isolated_containers(docker_client):
    ...
    def create_container(image_name: str, service_name: str, port: int, env_vars: Dict[str, str] = None):
...
def service_containers(docker_client, docker_network, mock_external_dependencies):
    ...
    def start_service(service_name: str, image_tag: str, port: int, extra_env: Dict[str, str] = None):
...
def pytest_configure(config):
    ...
    config.addinivalue_line("markers", "docker_integration: Integration tests with Docker containers")
