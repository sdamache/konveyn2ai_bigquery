...
class Config:
    ...
    APPROXIMATE_NEIGHBORS_COUNT: int = int(os.getenv("APPROXIMATE_NEIGHBORS_COUNT", "150"))
    
    # Service URLs
    AMATYA_SERVICE_URL: str = os.getenv("AMATYA_SERVICE_URL", "http://localhost:8001")
    JANAPADA_SERVICE_URL: str = os.getenv("JANAPADA_SERVICE_URL", "http://localhost:8002")
