...
class StructuredLogger:
    ...
    def _create_log_entry(
        self, level: str, category: LogCategory, message: str, **kwargs
    ) -> LogEntry:
    ...
    def log_ingestion_error(
        ...
        self.error(
            ...
            duration_ms=duration_ms,
            error=error,
            metadata={**(metadata or {}), "success": False},
        )
...
def log_cli_command(command: str, args: dict[str, Any]):
    ...
    logger.info(
        ...
        metadata={"command": command, "arguments": args},
    )
