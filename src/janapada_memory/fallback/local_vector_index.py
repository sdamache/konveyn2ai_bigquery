...
class LocalVectorIndex:
    ...
    def _ensure_embeddings_matrix(
        self, candidate_vectors: Dict[str, LocalVectorEntry]
    ) -> None:
        """
        ...
        embeddings_list = [
            candidate_vectors[chunk_id].embedding
            for chunk_id in self.candidate_chunk_ids
        ]
    ...
    def health_check(self) -> Dict[str, Any]:
        ...
        try:
            ...
            artifact_types = list(
                set(entry.artifact_type for entry in self.vectors.values())
            )
            ...
            if self.vectors:
                ...
                estimated_memory_mb = (vector_count * estimated_bytes_per_vector) / (
                    1024 * 1024
                )
            else:
