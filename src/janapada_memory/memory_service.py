...
class JanapadaMemoryService:
    ...
    def similarity_search(
        ...
        try:
            ...
            if k < 1 or k > 1000:
                raise MemoryServiceError(f"Parameter k must be between 1 and 1000, got {k}")
    ...
    def validate_configuration(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if not health.is_healthy:
                validation_results["errors"].append(f"BigQuery connection failed: {health.error_message}")
            ...
            if not table_accessible:
                validation_results["warnings"].append("source_embeddings table not found - may need setup")
            ...
            if self.enable_fallback:
                ...
                validation_results["checks"]["fallback_index"] = {
                    "status": "pass" if fallback_health["status"] == "healthy" else "fail",
