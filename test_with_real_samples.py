...
class RealSamplesTester:
    ...
    def save_results_to_file(self, search_results: List[Dict[str, Any]], metrics: Dict[str, Any]):
    ...
    def run_comprehensive_test(self):
        ...
        try:
            ...
            print("✅ BigQuery Memory Adapter successfully demonstrated with real repository data")
